...
public interface DisplayData {
    ...
    void displayAirPollutionData(String city,double lat, double lon, long dt, int aqi,
    ...
    void displayWeatherForecast(double[][] data,  double lat, double lon,
            String cityName, String[] weatherConditions);
